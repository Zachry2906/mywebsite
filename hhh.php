  ...
  <body>
    <div class="header">
      ...
      <div class="text-center px-2 text-white">
        <p class="text-white mb-1">Sun, 19 Mar 23</p>
        <h1 class="mb-3 display-5">hrthrth</h1>
        <p class="text-white">Sun, 19 Mar 23</p>
        <br />
      </div>
      <!-- Gambar -->
      <img src="img/8.jpeg" class="img-fluid mx-auto d-block" alt="galaxy" />
